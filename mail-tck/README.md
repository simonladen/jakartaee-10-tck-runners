...
`mvn clean install -pl . -pl tck-download -pl tck-download/jakarta-mail-tck -Dpayara.version=...`
...
```
mvn clean verify -Ppayara-server-managed -Dpayara.version=...  -pl . -pl mail-tck
```